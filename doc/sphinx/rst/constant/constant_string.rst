...
Register constants can be of type *string*, i.e. a string of textual characters.
This page will show you how the set up string constants, as well as showcase
...
The TOML file below shows how to set up a register list with two string constants.
Note that in the TOML, the type of the constant is determined by the type of the literal value.

.. literalinclude:: toml/constant_string.toml
   :caption: TOML that sets up a register list with string constants.
   :language: TOML
   :linenos:
...
.. literalinclude:: py/constant_string.py
   :caption: Python code that sets up a register list with string constants.
   :language: Python
   :linenos:
   :lines: 10-

See :meth:`.RegisterList.add_constant` and the :class:`.StringConstant` class
...
:download:`HTML page <../../../../generated/sphinx_rst/register_code/constant/constant_string/api/caesar_regs.html>`
...
.. collapse:: Click to expand/collapse code.
  ...
  .. literalinclude:: ../../../../generated/sphinx_rst/register_code/constant/constant_string/api/caesar_regs_pkg.vhd
...
.. collapse:: Click to expand/collapse code.
  ...
  .. literalinclude:: ../../../../generated/sphinx_rst/register_code/constant/constant_string/api/i_caesar.h
...
.. collapse:: Click to expand/collapse code.
  ...
  .. literalinclude:: ../../../../generated/sphinx_rst/register_code/constant/constant_string/api/caesar_regs.h
