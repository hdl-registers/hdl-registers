...
Register constants can be of type *float* for decimal numeric values.
This page will show you how the set up float constants, as well as showcase
...
The TOML file below shows how to set up a register list with two float constants.
Note that in the TOML, the type of the constant is determined by the type of the literal value.

.. literalinclude:: toml/constant_float.toml
   :caption: TOML that sets up a register list with float constants.
   :language: TOML
   :linenos:
...
.. literalinclude:: py/constant_float.py
   :caption: Python code that sets up a register list with float constants.
   :language: Python
   :linenos:
   :lines: 10-

See :meth:`.RegisterList.add_constant` and the :class:`.FloatConstant` class
...
:download:`HTML page <../../../../generated/sphinx_rst/register_code/constant/constant_float/api/caesar_regs.html>`
...
.. collapse:: Click to expand/collapse code.
  ...
  .. literalinclude:: ../../../../generated/sphinx_rst/register_code/constant/constant_float/api/caesar_regs_pkg.vhd
...
.. collapse:: Click to expand/collapse code.
  ...
  .. literalinclude:: ../../../../generated/sphinx_rst/register_code/constant/constant_float/api/i_caesar.h
...
.. collapse:: Click to expand/collapse code.
  ...
  .. literalinclude:: ../../../../generated/sphinx_rst/register_code/constant/constant_float/api/caesar_regs.h
