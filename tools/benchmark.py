...
# --------------------------------------------------------------------------------------------------
# Result 2024-12-09, before any optimizations:
# -----------------------------------------------------------------------------
#                       Tool |   LUT |   FF | LUT+FF relative (lower is better)
# ---------------------------+-------+------+----------------------------------
#  hdl-registers (6.2.1-dev) |   259 |  713 |                     1x (baseline)
#           cheby (1.6.dev0) |   136 |  428 |                             0.58x
#            corsair (1.0.4) |   168 |  409 |                             0.59x
#            PeakRDL (1.1.0) |   383 |  392 |                              0.8x
#               rggen (0.33) |   628 |  372 |                                1x
#            vhdmmio (0.0.3) |   304 |  440 |                             0.77x
#
# Result 2025-01-01, after optimization:
# -----------------------------------------------------------------------------
#                       Tool |   LUT |   FF | LUT+FF relative (lower is better)
# ---------------------------+-------+------+----------------------------------
#  hdl-registers (6.2.1-dev) |   97 |  305 |                     1x (baseline)
#           cheby (1.6.dev0) |  106 |  397 |                              1.3x
#            corsair (1.0.4) |  175 |  385 |                              1.4x
#            PeakRDL (1.1.0) |  376 |  365 |                              1.8x
#               rggen (0.33) |  594 |  344 |                              2.3x
