...
class RegisterList:
    ...
    def create_vhdl_package(self, output_path: Path, create_axi_lite_reg_file: bool = True):
        """
    ...
    def _create_vhdl_axi_lite_reg_file(self, vhd_file):
        ...
        generator = RegisterVhdlGeneratorAxiLite(
            ...
            generated_info=self.generated_source_info(include_source_definition_file=False),
        )
    ...
    def generated_source_info(self, include_source_definition_file: bool = True) -> list[str]:
        """
        ...
        Arguments:
            include_source_definition_file: Optionally exclude the information about source
                definition file.
        """
        ...
        file_info = ""
        if include_source_definition_file and self.source_definition_file is not None:
