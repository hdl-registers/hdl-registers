...
* Define your registers using
  `data file <https://hdl-registers.com/rst/user_guide/toml_format.html>`_
  or `Python API <https://hdl-registers.com/rst/user_guide/user_guide_python_api.html>`_.
