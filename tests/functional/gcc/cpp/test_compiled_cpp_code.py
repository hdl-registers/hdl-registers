...
namespace fpga_regs {{
  ...
  {{
    std::cerr << "getter: " << diagnostic_message << std::endl;
    std::exit(EXIT_FAILURE);
    return true;
  }}

  bool register_setter_assert_fail(std::string diagnostic_message)
  {{
    std::cerr << "setter: " << diagnostic_message << std::endl;
    std::exit(EXIT_FAILURE);
    return true;
  }}

  bool register_array_index_assert_fail(std::string diagnostic_message)
  {{
    std::cerr << "array_index: " << diagnostic_message << std::endl;
    std::exit(EXIT_FAILURE);
    return true;
  }}
}}
...
"""
    ...
    assert exception_info.value.stderr == (
        "array_index: Provided array index out of range in "
        f"{base_cpp_test.working_dir}/caesar.cpp:1278, message: "
...
"""
    ...
    assert exception_info.value.output == ""
    assert exception_info.value.stderr == (
        f"setter: Tried to set value out of range in {base_cpp_test.working_dir}/caesar.cpp:356, "
...
"""
    ...
    assert exception_info.value.output == ""
    assert exception_info.value.stderr == (
        f"setter: Tried to set value out of range in {base_cpp_test.working_dir}/caesar.cpp:360, "
...
"""
    ...
    assert exception_info.value.output == ""
    assert exception_info.value.stderr == (
        f"getter: Got read value out of range in {base_cpp_test.working_dir}/caesar.cpp:195, "
...
"""
    ...
    assert exception_info.value.output == ""
    assert exception_info.value.stderr == (
        f"getter: Got read value out of range in {base_cpp_test.working_dir}/caesar.cpp:191, "
...
"""
    ...
    assert exception_info.value.output == ""
    assert exception_info.value.stderr == (
        f"setter: Tried to set value out of range in {base_cpp_test.working_dir}/caesar.cpp:285, "
...
"""
    ...
    assert exception_info.value.output == ""
    assert exception_info.value.stderr == (
        f"setter: Tried to set value out of range in {base_cpp_test.working_dir}/caesar.cpp:321, "
