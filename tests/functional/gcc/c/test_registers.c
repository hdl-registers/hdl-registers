...
void test_field_indexes()
{
    ...
    assert(CAESAR_DUMMIES_FIRST_ARRAY_BIT_A_MASK == 1 << 7);
    assert(
        CAESAR_DUMMIES_FIRST_ARRAY_BIT_A_MASK_INVERSE == 0b11111111111111111111111101111111);

    assert(CAESAR_DUMMIES_FIRST_ARRAY_BIT_B_SHIFT == 8);
    assert(CAESAR_DUMMIES_FIRST_ARRAY_BIT_B_MASK == 1 << 8);
    assert(
        CAESAR_DUMMIES_FIRST_ARRAY_BIT_B_MASK_INVERSE == 0b11111111111111111111111011111111);

    assert(CAESAR_DUMMIES_FIRST_ARRAY_BIT_VECTOR_SHIFT == 9);
    assert(CAESAR_DUMMIES_FIRST_ARRAY_BIT_VECTOR_MASK == 31 << 9);
    assert(
        CAESAR_DUMMIES_FIRST_ARRAY_BIT_VECTOR_MASK_INVERSE == 0b11111111111111111100000111111111);
}
